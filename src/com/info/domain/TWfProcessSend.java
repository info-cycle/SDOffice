...
public class TWfProcessSend implements java.io.Serializable {
	...
	private static final long serialVersionUID = 7929990373215897898L;
	private Integer FId;
	...
	/** full constructor */
	public TWfProcessSend(Integer FId, Integer FProcessId, Integer FSendUser,
			String FSendTime, Integer FAcceptUser, String FAcceptTime,
			Integer FState, String FRemark) {
		this.FId = FId;
