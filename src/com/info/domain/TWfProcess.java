...
public class TWfProcess implements java.io.Serializable {
	 ...
	 */
	private static final long serialVersionUID = 7068093073767616685L;
	private Integer FId;
	...
	/** full constructor */
	public TWfProcess(Integer FId, String FTitle, Integer FTypeId,
			Integer FCreateUserId, Integer FCreateStation, String FCreateTime,
			Integer FCurrentUserId, Integer FState, Integer FFormPkid,
			String FCompleteTime, String FArchiveTime, Integer FArchiveUser) {
		this.FId = FId;
		this.FTitle = FTitle;
